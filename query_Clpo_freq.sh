##THIS SCRIPT RUNS EVERY 5 MINUTES(NOT ACCURATE BY CRON) and SEARCHES FOR BOOKINGS CREATED (NOT MODIFIED) IN THE LAST 1 HOUR FOR THAT DAY
...
TEMPDESTNAME="${TEMPDESTNAMEROOT}/CalpendoFreq${2}_${currentTime}.csv"

#This is where the file is moved to for AIG team to grab the csv file
DESTNAME="${DESTNAMEROOT}/CalpendoFreq${2}_${currentTime}.csv"
